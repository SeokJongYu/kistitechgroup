...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { desc: @talk.desc, meetingdate: @talk.meetingdate, name: @talk.name, title: @talk.title, url: @talk.url }
    end
  ...
  test "should update talk" do
    put :update, id: @talk, talk: { desc: @talk.desc, meetingdate: @talk.meetingdate, name: @talk.name, title: @talk.title, url: @talk.url }
    assert_redirected_to talk_path(assigns(:talk))
  end
